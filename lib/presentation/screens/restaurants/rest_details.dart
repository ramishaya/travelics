...
import '../../widgets/hotels_details_widgets/room_card.dart';
import '../../widgets/hotels_details_widgets/vip_container.dart';
import '../../widgets/rest_widgets/loaded_rest_details_widget.dart';
...
class _RestDetailsState extends State<RestDetails> {
  ...
  void initState() {
    super.initState();
    final restDetailsCubit = BlocProvider.of<RestDetailsCubit>(context);
    restDetailsCubit.fetchRestDetails(widget.restName);
    ...
    Widget buildBlocWidget() {
      return BlocBuilder<RestDetailsCubit, RestDetailsState>(
        builder: (context, state) {
          if (state is RestDetailsLoaded) {
            final restdetails = (state).restDetails;
            return RestDetailsWidget(
